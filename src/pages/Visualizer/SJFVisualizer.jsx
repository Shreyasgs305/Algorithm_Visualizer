...
import { runSJFNonPreemptive } from "../../algorithms/os/sjfNonPreemptive";
import { runSJFPreemptive } from "../../algorithms/os/sjfPreemptive";
import SjfAnimate from "../../visualizers/SjfAnimate";
import NonPreemptiveSJFInfo from "../informations/NonPreSjf";
import PreemptiveSJFInfo from "../informations/PreSjf";

function SJFVisualizer() {
  ...
  const handleSubmit = (e) => {
    ...
    const result =
      mode === "non"
        ? runSJFNonPreemptive(arrivalArray, burstArray)
        : runSJFPreemptive(arrivalArray, burstArray);
  ...
  return (
    <>
      ...
      <div className="container inputCategory my-5 pb-5 border rounded-5">
        <p className="fcfsHeading">Shortest Job First (SJF)</p>
        <hr />
      ...
      {mode === "non" ? <NonPreemptiveSJFInfo /> : <PreemptiveSJFInfo />}
    </>
  );
}
